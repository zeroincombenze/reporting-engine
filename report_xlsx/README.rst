...
==================================
|icon| Base report xlsx 10.0.1.0.1
==================================


**Base module to create xlsx report**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/reporting-engine/10.0/report_xlsx/static/description/icon.png
...
|it| Base rendiconti xlsx
-------------------------

Progetto basato sui moduli OCA rendiconti xlsx
...
* |menu| Setting > Apps |right_do| Select **report_xlsx** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **report_xlsx** > Update
